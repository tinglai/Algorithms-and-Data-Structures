...
void mapOutput(stringstream& ss, vector<TerrainInfo>& ter, unsigned int buck,
 unsigned int farmSize, unsigned int farmNum){
	deque<unsigned int> backPath;
	char t = ter[buck].c;
	if (t != 'S'){
...
void listOutput(stringstream& ss, vector<TerrainInfo>& ter, unsigned int buck,
 unsigned int farmSize, unsigned int farmNum){
	deque<unsigned int> backPath;
	char t = ter[buck].c;
	if (t != 'S'){
